...
export const signInWithWallet = async (walletAddress, signatureData) => {
  try {
    ...
    if (fetchError && fetchError.code === 'PGRST116') {
      ...
      // For wallet auth, we insert without user_id initially
      // Then the user can link their email/supabase auth later
      ...
      if (createError) {
        console.error('[v0] RLS Policy Error - ensure your users table allows anon inserts with wallet_address', createError);
        // If insert fails due to RLS, create minimal user object
        user = {
          wallet_address: walletAddress,
          created_at: new Date().toISOString(),
        };
