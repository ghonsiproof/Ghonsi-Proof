  ...
  const handleSupportingFiles = async (files) => {
    ...
    try {
      ...
      if (extractedData) {
        ...
        // You can add logic here to auto-fill form fields based on extracted data

        // For example, if the API returns certificate information, you could auto-populate proofName and summary
