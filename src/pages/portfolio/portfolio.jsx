...
function Portfolio() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen pb-28 max-w-xl mx-auto bg-[#0B0F1B] border-x border-white/5" style={{fontFamily: 'Inter, sans-serif'}}>
        {/* NavBar */}
            ...
            {filteredProofs.map((proof, idx) => (
              <div key={idx} className="bg-[#111625] rounded-xl border border-white/5 overflow-hidden mb-5 hover:border-white/10 transition-colors group">
                ...
                <div className="p-4 -mt-6 relative z-10">
                  ...
                  <p className="text-xs text-white leading-relaxed">{proof.description}</p>
